...
enum Color {
    ...
    static let redLineColor = Color.color(light: UIColor(red: 187.0/255.0, green: 1.0/255.0, blue: 3.0/255.0, alpha: 1.0),
                                          dark: UIColor(red: 187.0/255.0, green: 1.0/255.0, blue: 3.0/255.0, alpha: 1.0))

    static let background = Color.color(light: UIColor(red: 245.0/255.0, green: 245.0/255.0, blue: 245.0/255.0, alpha: 1.0),
